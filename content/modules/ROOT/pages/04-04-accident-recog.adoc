...
Once you complete this notebook, you can go back to check `03-03-information-extraction.ipynb` and then move onto next lab whcih is `04-05-model-serving.ipynb`.