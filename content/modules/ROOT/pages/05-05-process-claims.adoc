...
Since the pipeline run is on cpu and LLM takes a little more time, kindly proceed to next section whcih is theory and discus next steps and then come back to the resutls of this pipeline run after 6 to 10 minutes.
